...
public class FirebaseConfigPlugin extends ReflectiveCordovaPlugin {
    ...
    protected void pluginInitialize() {
        ...
        .setApplicationId("1:515750358206:android:1e41b46209a18ce9") // Required for Analytics.
        .setProjectId("dynamons-3-1cdf5") // Required for Firebase Installations.
        .setApiKey("AIzaSyAJfk_Feo4__C-oNz0eZ8lQmyF7rwYhnjk") // Required for Auth.
        .build();
        
        FirebaseApp.initializeApp(cordova.getContext(), options);
